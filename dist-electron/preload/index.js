...
electron.contextBridge.exposeInMainWorld("api", {
   ...
   */
  send: (channel, ...args) => {
    const validChannels = ["to-main-process", "hide-window", "show-window", "minimize-window", "close-window", "system-action", "window-control", "set-window-size", "script-action", "file-server-action", "secret-action", "open-image-window", "run-path", "update-global-hotkey", "update-smart-hotkeys"];
    if (validChannels.includes(channel)) {
